...
kubectl wait --for=condition=ready --timeout=180s -n keycloak issuer/letsencrypt
kubectl wait --for=condition=ready --timeout=180s -n keycloak issuer/letsencrypt-staging
